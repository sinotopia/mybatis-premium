 ...
 * the License.
 */
package com.ascrud.mybatisplus.generator.config.po;
            ...
            for (TableField field : fields) {
                ...
                if (field.isKeyFlag()) {
                    ...
                    if (field.isConvert() || field.isKeyIdentityFlag()) {
                        pkgSet.add("com.ascrud.mybatisplus.annotations.TableId");
                    }
                    // 自增
                    if (field.isKeyIdentityFlag()) {
                        pkgSet.add("com.ascrud.mybatisplus.enums.IdType");
                    }
                } else if (field.isConvert()) {
                    // 普通字段
                    pkgSet.add("com.ascrud.mybatisplus.annotations.TableField");
                }
                if (null != field.getFill()) {
                    // 填充字段
                    pkgSet.add("com.ascrud.mybatisplus.annotations.TableField");
                    pkgSet.add("com.ascrud.mybatisplus.enums.FieldFill");
                }
            }
            if (!pkgSet.isEmpty()) {
