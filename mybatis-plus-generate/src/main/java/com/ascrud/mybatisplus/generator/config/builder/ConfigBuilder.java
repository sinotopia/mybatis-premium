 ...
 * the License.
 */
package com.ascrud.mybatisplus.generator.config.builder;
...
import com.ascrud.mybatisplus.generator.config.ConstVal;
...
import com.ascrud.mybatisplus.generator.config.IDbQuery;
...
import com.ascrud.mybatisplus.generator.config.po.TableField;
...
public class ConfigBuilder {
     ...
     * <p>
     * 检查是否有
     * {@link com.ascrud.mybatisplus.annotations.TableId}
     * {@link com.ascrud.mybatisplus.annotations.TableField}
     * 注解
     * </p>
     *
     * @param config
    ...
    private void checkTableIdTableFieldAnnotation(StrategyConfig config, TableInfo tableInfo, String[] fieldPrefix) {
        ...
        if (importTableFieldAnnotaion) {
            tableInfo.getImportPackages().add(com.ascrud.mybatisplus.annotations.TableField.class.getCanonicalName());
        }
        if (importTableIdAnnotaion) {
            tableInfo.getImportPackages().add(com.ascrud.mybatisplus.annotations.TableId.class.getCanonicalName());
        }
        if (globalConfig.getIdType() != null) {
            if (!importTableIdAnnotaion) {
                tableInfo.getImportPackages().add(com.ascrud.mybatisplus.annotations.TableId.class.getCanonicalName());
            }
            tableInfo.getImportPackages().add(com.ascrud.mybatisplus.enums.IdType.class.getCanonicalName());
        }
    }
