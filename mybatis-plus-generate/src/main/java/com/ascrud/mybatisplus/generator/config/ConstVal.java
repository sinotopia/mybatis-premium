...
public class ConstVal {
    ...
    public static final String SUPERD_MAPPER_CLASS = "com.ascrud.mybatisplus.mapper.BaseMapper";
    public static final String SUPERD_SERVICE_CLASS = "com.ascrud.mybatisplus.service.IService";
    public static final String SUPERD_SERVICEIMPL_CLASS = "com.ascrud.mybatisplus.service.impl.ServiceImpl";
