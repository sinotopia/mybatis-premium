 ...
 * the License.
 */
package com.ascrud.mybatisplus.mapper;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.ascrud.mybatisplus.toolkit.GlobalConfigUtils;
...
public class SqlRunner {
    ...
    public static final String INSERT = "com.ascrud.mybatisplus.mapper.SqlRunner.Insert";
    public static final String DELETE = "com.ascrud.mybatisplus.mapper.SqlRunner.Delete";
    public static final String UPDATE = "com.ascrud.mybatisplus.mapper.SqlRunner.Update";
    public static final String SELECT_LIST = "com.ascrud.mybatisplus.mapper.SqlRunner.SelectList";
    public static final String SELECT_OBJS = "com.ascrud.mybatisplus.mapper.SqlRunner.SelectObjs";
    public static final String COUNT = "com.ascrud.mybatisplus.mapper.SqlRunner.Count";
