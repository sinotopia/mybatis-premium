 ...
 * the License.
 */
package com.ascrud.mybatisplus.test.mysql.mapper;
...
import com.ascrud.mybatisplus.test.mysql.MyBaseMapper;
...
public interface UserMapper extends MyBaseMapper<User> {
    ...
    /**
     * 自定义注入逻辑删除方法<br>
     * com.ascrud.mybatisplus.test.mysql.MetaObjectHandlerTest
     */
