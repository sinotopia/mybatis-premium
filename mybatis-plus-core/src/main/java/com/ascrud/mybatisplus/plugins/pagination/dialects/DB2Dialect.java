 ...
 * the License.
 */
package com.ascrud.mybatisplus.plugins.pagination.dialects;

import com.ascrud.mybatisplus.plugins.pagination.IDialect;
...
public class DB2Dialect implements IDialect {
    ...
    public String buildPaginationSql(String originalSql, int offset, int limit) {
        ...
        // https://github.com/ascrud/mybatis-plus/issues/450
        if (offset > 0) {
