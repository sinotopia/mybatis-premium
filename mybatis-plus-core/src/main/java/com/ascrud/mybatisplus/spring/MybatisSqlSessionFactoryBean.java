 ...
 * the License.
 */
package com.ascrud.mybatisplus.spring;
...
import com.ascrud.mybatisplus.MybatisXMLConfigBuilder;
import com.ascrud.mybatisplus.entity.GlobalConfiguration;
import com.ascrud.mybatisplus.enums.IEnum;
import com.ascrud.mybatisplus.exceptions.MybatisPlusException;
import com.ascrud.mybatisplus.mapper.SqlRunner;
import com.ascrud.mybatisplus.toolkit.GlobalConfigUtils;
import com.ascrud.mybatisplus.toolkit.PackageHelper;
            ...
            for (Class cls : classes) {
                if (cls.isEnum()) {
                    if (IEnum.class.isAssignableFrom(cls)) {
                        typeHandlerRegistry.register(cls.getName(), com.ascrud.mybatisplus.handlers.EnumTypeHandler.class.getCanonicalName());
                    } else {
